...
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I am creating the career of my dreams.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I have a lot to offer the world.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I can and I will.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I make myself proud.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I am worth it.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I have enough time.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I am confident that I can achieve anything.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I have the power to create change.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I am transforming.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I passionate about my creativity.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I believe in myself.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I am becoming wealthy.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'My productivity does not define my worth.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'The future is safe. All is well.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Career', 'I overcome my fears by following my dreams.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Happiness', 'I am in control of my feelings.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Happiness', 'I choose to be happy.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Happiness', 'I am living in the moment.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Happiness', 'I am happy now in this moment which is all there is.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Happiness', 'I am happy to be who I am, where I am, and when I am.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Happiness', 'I deserve to be happy and loved.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Happiness', 'I am free.', false);
INSERT INTO beans (category, bean, favorite) VALUES ('Happiness', 'I am happy. I am healthy. I am wealthy. I am loved. I am respected.', false);
